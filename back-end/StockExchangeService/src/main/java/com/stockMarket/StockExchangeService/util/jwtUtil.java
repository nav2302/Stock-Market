package com.stockMarket.StockExchangeService.util;
...
import com.stockMarket.StockExchangeService.service.UserService;
...
public class jwtUtil {
	...
	public User checkToken(String token) {
		...
		User user = userService.findByEmailAndUsertype(claim.get(SES_EMAIL).toString(), claim.get(SES_TYPE).toString());
		return user;
	}
